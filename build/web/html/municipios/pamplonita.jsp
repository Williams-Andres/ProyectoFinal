<%-- 
    Document   : pamplonita
    Created on : 20/07/2023, 05:59:27 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/pamplonita.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Pamplonita Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/pamplonita/" alt="imagenPamplonita1">
                <img class="imagen2" src="/src/municipios/pamplonita/" alt="imagenPamplonita2">
                <img class="imagen3" src="/src/municipios/pamplonita/" alt="imagenPamplonita3">
                <img class="imagen4" src="/src/municipios/pamplonita/" alt="imagenPamplonita4">
                <img class="imagen5" src="/src/municipios/pamplonita/" alt="imagenPamplonita5">
            </aside>
    ...
    <script src="../../js/municipios/pamplonita.js"></script>
</body>

<%-- 
    Document   : ocaña
    Created on : 20/07/2023, 05:58:49 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/ocaña.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Ocaña Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/ocaña/ocaña1.jpg" alt="imagenOCaña1">
                <img class="imagen2" src="/src/municipios/ocaña/ocaña2.jpg" alt="imagenOCaña2">
                <img class="imagen3" src="/src/municipios/ocaña/ocaña3.jpg" alt="imagenOCaña3">
                <img class="imagen4" src="/src/municipios/ocaña/ocaña4.jpg" alt="imagenOCaña4">
                <img class="imagen5" src="/src/municipios/ocaña/ocaña5.jpg" alt="imagenOCaña5">
            </aside>
    ...
    <script src="../../js/municipios/ocaña.js"></script>

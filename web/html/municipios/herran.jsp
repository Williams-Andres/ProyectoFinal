<%-- 
    Document   : herran
    Created on : 20/07/2023, 05:55:44 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/herran.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Herrán Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/herran/" alt="imagenHerran1">
                <img class="imagen2" src="/src/municipios/herran/" alt="imagenHerran2">
                <img class="imagen3" src="/src/municipios/herran/" alt="imagenHerran3">
                <img class="imagen4" src="/src/municipios/herran/" alt="imagenHerran4">
                <img class="imagen5" src="/src/municipios/herran/" alt="imagenHerran5">
            </aside>
    ...
    <script src="../../js/municipios/herran.js"></script>
</body>

<%-- 
    Document   : bochalema
    Created on : 20/07/2023, 05:51:15 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/bochalema.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Bochalema Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/bochalema/bochalema1.jpg" alt="imagenBochalema1">
                <img class="imagen2" src="/src/municipios/bochalema/bochalema2.jpg" alt="imagenBochalema2">
                <img class="imagen3" src="/src/municipios/bochalema/bochalema3.jpg" alt="imagenBochalema3">
                <img class="imagen4" src="/src/municipios/bochalema/bochalema4.jpg" alt="imagenBochalema4">
                <img class="imagen5" src="/src/municipios/bochalema/bochalema5.png" alt="imagenBochalema5">
            </aside>
    ...
    <script src="../../js/municipios/bochalema.js"></script>
</body>

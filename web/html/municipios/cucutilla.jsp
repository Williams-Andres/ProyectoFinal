<%-- 
    Document   : cucutilla
    Created on : 20/07/2023, 05:54:02 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/cucutilla.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Cucutilla Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/cucutilla/cucutilla1.jpg" alt="imagenCucutilla1">
                <img class="imagen2" src="/src/municipios/cucutilla/cucutilla2.jpg" alt="imagenCucutilla2">
                <img class="imagen3" src="/src/municipios/cucutilla/cucutilla3.jpg" alt="imagenCucutilla3">
                <img class="imagen4" src="/src/municipios/cucutilla/cucutilla4.jpg" alt="imagenCucutilla4">
                <img class="imagen5" src="/src/municipios/cucutilla/cucutilla5.jpg" alt="imagenCucutilla5">
            </aside>
    ...
    <script src="../../js/municipios/cucutilla.js"></script>
</body>

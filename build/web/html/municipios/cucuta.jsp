<%-- 
    Document   : cucuta
    Created on : 20/07/2023, 05:49:05 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/cucuta.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Cúcuta Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/cucuta/cucuta1.jpg" alt="imagenCucuta1">
                <img class="imagen2" src="/src/municipios/cucuta/cucuta2.jpg" alt="imagenCucuta2">
                <img class="imagen3" src="/src/municipios/cucuta/cucuta3.jpg" alt="imagenCucuta3">
                <img class="imagen4" src="/src/municipios/cucuta/cucuta4.jpg" alt="imagenCucuta4">
                <img class="imagen5" src="/src/municipios/cucuta/cucuta5.jpg" alt="imagenCucuta5">
            </aside>
    ...
    <script src="../../js/municipios/cucuta.js"></script>
</body>

<%-- 
    Document   : sanCalixto
    Created on : 20/07/2023, 06:02:33 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/sanCalixto.css" />
</head>
...
<body>
    ...
    <main>
        <h1>San Calixto Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/sanCalixto/sanCalixto1.jpg" alt="imagenSanCalixto1">
                <img class="imagen2" src="/src/municipios/sanCalixto/sanCalixto2.jpg" alt="imagenSanCalixto2">
                <img class="imagen3" src="/src/municipios/sanCalixto/sanCalixto3.jpg" alt="imagenSanCalixto3">
                <img class="imagen4" src="/src/municipios/sanCalixto/sanCalixto4.jpg" alt="imagenSanCalixto4">
                <img class="imagen5" src="/src/municipios/sanCalixto/sanCalixto5.jpg" alt="imagenSanCalixto5">
            </aside>
    ...
    <script src="../../js/municipios/sanCalixto.js"></script>
</body>

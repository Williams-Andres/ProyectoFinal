<%-- 
    Document   : durania
    Created on : 20/07/2023, 05:54:22 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/durania.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Durania Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/durania/Durania1.jpg" alt="imagenDurania1">
                <img class="imagen2" src="/src/municipios/durania/Durania2.jpg" alt="imagenDurania2">
                <img class="imagen3" src="/src/municipios/durania/Durania3.jpg" alt="imagenDurania3">
                <img class="imagen4" src="/src/municipios/durania/Durania4.jpg" alt="imagenDurania4">
                <img class="imagen5" src="/src/municipios/durania/Durania5.jpg" alt="imagenDurania5">
            </aside>
    ...
    <script src="../../js/municipios/durania.js"></script>
</body>

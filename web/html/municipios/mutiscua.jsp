<%-- 
    Document   : mutiscua
    Created on : 20/07/2023, 05:58:35 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/lourdes.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Lourdes Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/lourdes/" alt="imagenLourdes1">
                <img class="imagen2" src="/src/municipios/lourdes/" alt="imagenLourdes2">
                <img class="imagen3" src="/src/municipios/lourdes/" alt="imagenLourdes3">
                <img class="imagen4" src="/src/municipios/lourdes/" alt="imagenLourdes4">
                <img class="imagen5" src="/src/municipios/lourdes/" alt="imagenLourdes5">
            </aside>
    ...
    <script src="../../js/municipios/lourdes.js"></script>
</body>

<%-- 
    Document   : pamplona
    Created on : 20/07/2023, 05:59:11 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/pamplona.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Pamplona Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/pamplona/imgPamplona1.png" alt="imagenPamplona1">
                <img class="imagen2" src="/src/municipios/pamplona/imgPamplona2.png" alt="imagenPamplona2">
                <img class="imagen3" src="/src/municipios/pamplona/imgPamplona3.png" alt="imagenPamplona3">
                <img class="imagen4" src="/src/municipios/pamplona/imgPamplona4.png" alt="imagenPamplona4">
                <img class="imagen5" src="/src/municipios/pamplona/imgPamplona5.png" alt="imagenPamplona5">
            </aside>
    ...
    <script src="../../js/municipios/pamplona.js"></script>
</body>
</html>
<%-- 
    Document   : toledo
    Created on : 20/07/2023, 06:05:04 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/toledo.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Toledo Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/toledo/toledo1.png" alt="imagenToledo1">
                <img class="imagen2" src="/src/municipios/toledo/toledo2.avif" alt="imagenToledo2">
                <img class="imagen3" src="/src/municipios/toledo/toledo3.jpg" alt="imagenToledo3">
                <img class="imagen4" src="/src/municipios/toledo/toledo4.jpeg" alt="imagenToledo4">
                <img class="imagen5" src="/src/municipios/toledo/toledo5.webp" alt="imagenToledo5">
            </aside>
    ...
    <script src="../../js/municipios/toledo.js"></script>
</body>

<%-- 
    Document   : teorama
    Created on : 20/07/2023, 06:04:34 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/teorama.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Teorama Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/teorama/teorama1.jpg" alt="imagenTeorama1">
                <img class="imagen2" src="/src/municipios/teorama/teorama2.jpg" alt="imagenTeorama2">
                <img class="imagen3" src="/src/municipios/teorama/teorama3.jpg" alt="imagenTeorama3">
                <img class="imagen4" src="/src/municipios/teorama/teorama4.png" alt="imagenTeorama4">
                <img class="imagen5" src="/src/municipios/teorama/teorama5.png" alt="imagenTeorama5">
            </aside>
    ...
    <script src="../../js/municipios/teorama.js"></script>
</body>

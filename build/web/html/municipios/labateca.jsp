<%-- 
    Document   : labateca
    Created on : 20/07/2023, 05:56:32 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/labateca.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Labateca Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/labateca/" alt="imagenLabateca1">
                <img class="imagen2" src="/src/municipios/labateca/" alt="imagenLabateca2">
                <img class="imagen3" src="/src/municipios/labateca/" alt="imagenLabateca3">
                <img class="imagen4" src="/src/municipios/labateca/" alt="imagenLabateca4">
                <img class="imagen5" src="/src/municipios/labateca/" alt="imagenLabateca5">
            </aside>
    ...
    <script src="../../js/municipios/labateca.js"></script>
</body>

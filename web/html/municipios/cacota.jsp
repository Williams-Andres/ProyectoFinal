<%-- 
    Document   : cacota
    Created on : 20/07/2023, 05:52:43 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/cacota.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Cácota Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/cacota/cacota1.jpg" alt="imagenCacota1">
                <img class="imagen2" src="/src/municipios/cacota/cacota2.jpg" alt="imagenCacota2">
                <img class="imagen3" src="/src/municipios/cacota/cacota3.jpg" alt="imagenCacota3">
                <img class="imagen4" src="/src/municipios/cacota/cacota4.jpg" alt="imagenCacota4">
                <img class="imagen5" src="/src/municipios/cacota/cacota5.jpg" alt="imagenCacota5">
            </aside>
    ...
    <script src="../../js/municipios/cacota.js"></script>
</body>

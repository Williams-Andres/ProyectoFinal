<%-- 
    Document   : convencion
    Created on : 20/07/2023, 05:53:41 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/convencion.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Convención Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/convencion/convencion1.jpg" alt="imagenConvencion1">
                <img class="imagen2" src="/src/municipios/convencion/convencion2.jpg" alt="imagenConvencion2">
                <img class="imagen3" src="/src/municipios/convencion/convencion3.jpg" alt="imagenConvencion3">
                <img class="imagen4" src="/src/municipios/convencion/convencion4.jpg" alt="imagenConvencion4">
                <img class="imagen5" src="/src/municipios/convencion/convencion5.jpg" alt="imagenConvencion5">
            </aside>
    ...
    <script src="../../js/municipios/convencion.js"></script>
</body>

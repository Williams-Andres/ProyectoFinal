<%-- 
    Document   : arboledas
    Created on : 20/07/2023, 05:50:35 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/arboledas.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Arboledas Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/arboledas/arboledas1.jpg" alt="imagenArboledas1">
                <img class="imagen2" src="/src/municipios/arboledas/arboledas2.jpg" alt="imagenArboledas2">
                <img class="imagen3" src="/src/municipios/arboledas/arboledas3.jpg" alt="imagenArboledas3">
                <img class="imagen4" src="/src/municipios/arboledas/arboledas4.jpg" alt="imagenArboledas4">
                <img class="imagen5" src="/src/municipios/arboledas/arboledas5.jpg" alt="imagenArboledas5">
            </aside>
    ...
    <script src="../../js/municipios/arboledas.js"></script>
</body>

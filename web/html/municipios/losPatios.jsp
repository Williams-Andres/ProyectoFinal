<%-- 
    Document   : losPatios
    Created on : 20/07/2023, 05:57:52 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/losPatios.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Los Patios Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/losPatios/" alt="imagenLosPatios1">
                <img class="imagen2" src="/src/municipios/losPatios/" alt="imagenLosPatios2">
                <img class="imagen3" src="/src/municipios/losPatios/" alt="imagenLosPatios3">
                <img class="imagen4" src="/src/municipios/losPatios/" alt="imagenLosPatios4">
                <img class="imagen5" src="/src/municipios/losPatios/" alt="imagenLosPatios5">
            </aside>
    ...
    <script src="../../js/municipios/losPatios.js"></script>
</body>

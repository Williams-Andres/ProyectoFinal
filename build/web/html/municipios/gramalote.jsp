<%-- 
    Document   : gramalote
    Created on : 20/07/2023, 05:55:15 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/gramalote.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Gramalote Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/gramalote/gramalote1.jpg" alt="imagenGramalote1">
                <img class="imagen2" src="/src/municipios/gramalote/gramalote2.jpg" alt="imagenGramalote2">
                <img class="imagen3" src="/src/municipios/gramalote/gramalote3.jpg" alt="imagenGramalote3">
                <img class="imagen4" src="/src/municipios/gramalote/gramalote4.jpg" alt="imagenGramalote4">
                <img class="imagen5" src="/src/municipios/gramalote/gramalote5.webp" alt="imagenGramalote5">
            </aside>
    ...
    <script src="../../js/municipios/gramalote.js"></script>
</body>

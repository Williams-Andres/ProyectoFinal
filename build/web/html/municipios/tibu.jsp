<%-- 
    Document   : tibu
    Created on : 20/07/2023, 06:04:49 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/tibu.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Tibú Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/tibu/" alt="imagenTibu1">
                <img class="imagen2" src="/src/municipios/tibu/" alt="imagenTibu2">
                <img class="imagen3" src="/src/municipios/tibu/" alt="imagenTibu3">
                <img class="imagen4" src="/src/municipios/tibu/" alt="imagenTibu4">
                <img class="imagen5" src="/src/municipios/tibu/" alt="imagenTibu5">
            </aside>
    ...
    <script src="../../js/municipios/tibu.js"></script>
</body>

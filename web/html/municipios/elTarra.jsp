<%-- 
    Document   : elTarra
    Created on : 20/07/2023, 05:54:38 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/elTarra.css" />
</head>
...
<body>
    ...
    <main>
        <h1>El Tarra Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/elTarra/tarra1.jpg" alt="imagenElTarra1">
                <img class="imagen2" src="/src/municipios/elTarra/tarra2.webp" alt="imagenElTarra2">
                <img class="imagen3" src="/src/municipios/elTarra/tarra3.jpg" alt="imagenElTarra3">
                <img class="imagen4" src="/src/municipios/elTarra/tarra4.jpg" alt="imagenElTarra4">
                <img class="imagen5" src="/src/municipios/elTarra/tarra5.jpeg" alt="imagenElTarra5">
            </aside>
    ...
    <script src="../../js/municipios/elTarra.js"></script>
</body>

<%-- 
    Document   : cachira
    Created on : 20/07/2023, 05:52:17 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/cachira.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Cachira Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/cachira/cachira1.jpg" alt="imagenCachira1">
                <img class="imagen2" src="/src/municipios/cachira/cachira2.jpg" alt="imagenCachira2">
                <img class="imagen3" src="/src/municipios/cachira/cachira3.jpg" alt="imagenCachira3">
                <img class="imagen4" src="/src/municipios/cachira/cachira4.jpg" alt="imagenCachira4">
                <img class="imagen5" src="/src/municipios/cachira/cachira5.jpg" alt="imagenCachira5">
            </aside>
    ...
    <script src="../../js/municipios/cachira.js"></script>
</body>

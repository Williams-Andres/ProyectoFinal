<%-- 
    Document   : laPlaya
    Created on : 20/07/2023, 05:57:12 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/laPlaya.css" />
</head>
...
<body>
    ...
    <main>
        <h1>La Playa Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/laPlaya/" alt="imagenLaPlaya1">
                <img class="imagen2" src="/src/municipios/laPlaya/" alt="imagenLaPlaya2">
                <img class="imagen3" src="/src/municipios/laPlaya/" alt="imagenLaPlaya3">
                <img class="imagen4" src="/src/municipios/laPlaya/" alt="imagenLaPlaya4">
                <img class="imagen5" src="/src/municipios/laPlaya/" alt="imagenLaPlaya5">
            </aside>
    ...
    <script src="../../js/municipios/laPlaya.js"></script>
</body>

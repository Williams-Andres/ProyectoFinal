<%-- 
    Document   : ragonvalia
    Created on : 20/07/2023, 06:00:11 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/ragonvalia.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Ragonvalia Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/ragonvalia/" alt="imagenRagonvalia1">
                <img class="imagen2" src="/src/municipios/ragonvalia/" alt="imagenRagonvalia2">
                <img class="imagen3" src="/src/municipios/ragonvalia/" alt="imagenRagonvalia3">
                <img class="imagen4" src="/src/municipios/ragonvalia/" alt="imagenRagonvalia4">
                <img class="imagen5" src="/src/municipios/ragonvalia/" alt="imagenRagonvalia5">
            </aside>
    ...
    <script src="../../js/municipios/ragonvalia.js"></script>
</body>

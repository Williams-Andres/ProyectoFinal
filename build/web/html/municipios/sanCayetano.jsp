<%-- 
    Document   : sanCayetano
    Created on : 20/07/2023, 06:02:50 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/sanCayetano.css" />
</head>
...
<body>
    ...
    <main>
        <h1>San Cayetano Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/sanCayetano/" alt="imagenSanCayetano1">
                <img class="imagen2" src="/src/municipios/sanCayetano/" alt="imagenSanCayetano2">
                <img class="imagen3" src="/src/municipios/sanCayetano/" alt="imagenSanCayetano3">
                <img class="imagen4" src="/src/municipios/sanCayetano/" alt="imagenSanCayetano4">
                <img class="imagen5" src="/src/municipios/sanCayetano/" alt="imagenSanCayetano5">
            </aside>
    ...
    <script src="../../js/municipios/sanCayetano.js"></script>
</body>

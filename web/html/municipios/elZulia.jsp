<%-- 
    Document   : elZulia
    Created on : 20/07/2023, 05:54:56 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/elZulia.css" />
</head>
...
<body>
    ...
    <main>
        <h1>El Zulia Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/elZulia/elZulia1.jpg" alt="imagenElZulia1">
                <img class="imagen2" src="/src/municipios/elZulia/elZulia2.jpg" alt="imagenElZulia2">
                <img class="imagen3" src="/src/municipios/elZulia/elZulia3.jpg" alt="imagenElZulia3">
                <img class="imagen4" src="/src/municipios/elZulia/elZulia4.avif" alt="imagenElZulia4">
                <img class="imagen5" src="/src/municipios/elZulia/elZulia5.jpeg" alt="imagenElZulia5">
            </aside>
    ...
    <script src="../../js/municipios/elZulia.js"></script>
</body>

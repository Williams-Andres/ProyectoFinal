<%-- 
    Document   : villaRosario
    Created on : 20/07/2023, 06:05:35 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/villaRosario.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Villa del Rosario Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/villaRosario/villaDelRosario1.jpg" alt="imagenVillaRosario1">
                <img class="imagen2" src="/src/municipios/villaRosario/villaDelRosario2.jpg" alt="imagenVillaRosario2">
                <img class="imagen3" src="/src/municipios/villaRosario/villaDelRosario3.jpg" alt="imagenVillaRosario3">
                <img class="imagen4" src="/src/municipios/villaRosario/villaDelRosario4.jpg" alt="imagenVillaRosario4">
                <img class="imagen5" src="/src/municipios/villaRosario/villaDelRosario5.jpg" alt="imagenVillaRosario5">
            </aside>
    ...
    <script src="../../js/municipios/villaRosario.js"></script>
</body>

<%-- 
    Document   : abrego
    Created on : 20/07/2023, 05:49:52 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/abrego.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Abrego Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/abrego/abrego1.jpg" alt="imagenAbrego1">
                <img class="imagen2" src="/src/municipios/abrego/abrego2.jpg" alt="imagenAbrego2">
                <img class="imagen3" src="/src/municipios/abrego/abrego3.jpg" alt="imagenAbrego3">
                <img class="imagen4" src="/src/municipios/abrego/abrego4.jpg" alt="imagenAbrego4">
                <img class="imagen5" src="/src/municipios/abrego/abrego5.jpg" alt="imagenAbrego5">
            </aside>
    ...
    <script src="../../js/municipios/abrego.js"></script>
</body>

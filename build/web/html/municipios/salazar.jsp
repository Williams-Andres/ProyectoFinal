<%-- 
    Document   : salazar
    Created on : 20/07/2023, 06:02:12 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/salazar.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Salazar Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/salazar/" alt="imagenSalazar1">
                <img class="imagen2" src="/src/municipios/salazar/" alt="imagenSalazar2">
                <img class="imagen3" src="/src/municipios/salazar/" alt="imagenSalazar3">
                <img class="imagen4" src="/src/municipios/salazar/" alt="imagenSalazar4">
                <img class="imagen5" src="/src/municipios/salazar/" alt="imagenSalazar5">
            </aside>
    ...
    <script src="../../js/municipios/salazar.js"></script>
</body>

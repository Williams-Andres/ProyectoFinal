<%-- 
    Document   : silos
    Created on : 20/07/2023, 06:03:39 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/silos.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Silos Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/silos/" alt="imagenSilos1">
                <img class="imagen2" src="/src/municipios/silos/" alt="imagenSilos2">
                <img class="imagen3" src="/src/municipios/silos/" alt="imagenSilos3">
                <img class="imagen4" src="/src/municipios/silos/" alt="imagenSilos4">
                <img class="imagen5" src="/src/municipios/silos/" alt="imagenSilos5">
            </aside>
    ...
    <script src="../../js/municipios/silos.js"></script>
</body>

<%-- 
    Document   : sardinata
    Created on : 20/07/2023, 06:03:22 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/sardinata.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Sardinata Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/sardinata/sardinata1.jpg" alt="imagenSardinata1">
                <img class="imagen2" src="/src/municipios/sardinata/sardinata2.jpg" alt="imagenSardinata2">
                <img class="imagen3" src="/src/municipios/sardinata/sardinata3.jpg" alt="imagenSardinata3">
                <img class="imagen4" src="/src/municipios/sardinata/sardinata4.jpg" alt="imagenSardinata4">
                <img class="imagen5" src="/src/municipios/sardinata/sardinata5.jpg" alt="imagenSardinata5">
            </aside>
    ...
    <script src="../../js/municipios/sardinata.js"></script>
</body>

<%-- 
    Document   : hacari
    Created on : 20/07/2023, 05:55:30 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/hacari.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Hacarí Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/hacari/hacari1.jpg" alt="imagenHacari1">
                <img class="imagen2" src="/src/municipios/hacari/hacari2.jpg" alt="imagenHacari2">
                <img class="imagen3" src="/src/municipios/hacari/hacari3.jpg" alt="imagenHacari3">
                <img class="imagen4" src="/src/municipios/hacari/hacari4.jpg" alt="imagenHacari4">
                <img class="imagen5" src="/src/municipios/hacari/hacari5.jpg" alt="imagenHacari5">
            </aside>
    ...
    <script src="../../js/municipios/hacari.js"></script>
</body>

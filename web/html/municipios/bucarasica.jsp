<%-- 
    Document   : bucarasica
    Created on : 20/07/2023, 05:51:45 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/bucarasica.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Bucarasica Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/bucarasica/" alt="imagenBucarasica1">
                <img class="imagen2" src="/src/municipios/bucarasica/" alt="imagenBucarasica2">
                <img class="imagen3" src="/src/municipios/bucarasica/" alt="imagenBucarasica3">
                <img class="imagen4" src="/src/municipios/bucarasica/" alt="imagenBucarasica4">
                <img class="imagen5" src="/src/municipios/bucarasica/" alt="imagenBucarasica5">
            </aside>
    ...
    <script src="../../js/municipios/bucarasica.js"></script>
</body>

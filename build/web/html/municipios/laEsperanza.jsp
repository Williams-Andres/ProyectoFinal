<%-- 
    Document   : laEsperanza
    Created on : 20/07/2023, 05:56:52 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/laEsperanza.css" />
</head>
...
<body>
    ...
    <main>
        <h1>La Esperanza Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/laEsperanza/" alt="imagenLaEsperanza1">
                <img class="imagen2" src="/src/municipios/laEsperanza/" alt="imagenLaEsperanza2">
                <img class="imagen3" src="/src/municipios/laEsperanza/" alt="imagenLaEsperanza3">
                <img class="imagen4" src="/src/municipios/laEsperanza/" alt="imagenLaEsperanza4">
                <img class="imagen5" src="/src/municipios/laEsperanza/" alt="imagenLaEsperanza5">
            </aside>
    ...
    <script src="../../js/municipios/laEsperanza.js"></script>
</body>

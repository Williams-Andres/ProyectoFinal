<%-- 
    Document   : santiago
    Created on : 20/07/2023, 06:03:07 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/santiago.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Santiago Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/santiago/" alt="imagenSantiago1">
                <img class="imagen2" src="/src/municipios/santiago/" alt="imagenSantiago2">
                <img class="imagen3" src="/src/municipios/santiago/" alt="imagenSantiago3">
                <img class="imagen4" src="/src/municipios/santiago/" alt="imagenSantiago4">
                <img class="imagen5" src="/src/municipios/santiago/" alt="imagenSantiago5">
            </aside>
    ...
    <script src="../../js/municipios/santiago.js"></script>
</body>

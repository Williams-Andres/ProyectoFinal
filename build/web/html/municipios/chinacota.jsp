<%-- 
    Document   : chinacota
    Created on : 20/07/2023, 05:53:02 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/chinacota.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Chinácota Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/chinacota/" alt="imagenChinacota1">
                <img class="imagen2" src="/src/municipios/chinacota/" alt="imagenChinacota2">
                <img class="imagen3" src="/src/municipios/chinacota/" alt="imagenChinacota3">
                <img class="imagen4" src="/src/municipios/chinacota/" alt="imagenChinacota4">
                <img class="imagen5" src="/src/municipios/chinacota/" alt="imagenChinacota5">
            </aside>
    ...
    <script src="../../js/municipios/chinacota.js"></script>
</body>

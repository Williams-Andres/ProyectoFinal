<%-- 
    Document   : chitaga
    Created on : 20/07/2023, 05:53:21 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/chitaga.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Chitagá Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/chitaga/" alt="imagenChitaga1">
                <img class="imagen2" src="/src/municipios/chitaga/" alt="imagenChitaga2">
                <img class="imagen3" src="/src/municipios/chitaga/" alt="imagenChitaga3">
                <img class="imagen4" src="/src/municipios/chitaga/" alt="imagenChitaga4">
                <img class="imagen5" src="/src/municipios/chitaga/" alt="imagenChitaga5">
            </aside>
    ...
    <script src="../../js/municipios/chitaga.js"></script>
</body>

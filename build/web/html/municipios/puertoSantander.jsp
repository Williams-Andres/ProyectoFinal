<%-- 
    Document   : puertoSantander
    Created on : 20/07/2023, 05:59:44 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/puertoSantander.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Puerto Santander Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/puertoSantander/" alt="imagenPuertoSantander1">
                <img class="imagen2" src="/src/municipios/puertoSantander/" alt="imagenPuertoSantander2">
                <img class="imagen3" src="/src/municipios/puertoSantander/" alt="imagenPuertoSantander3">
                <img class="imagen4" src="/src/municipios/puertoSantander/" alt="imagenPuertoSantander4">
                <img class="imagen5" src="/src/municipios/puertoSantander/" alt="imagenPuertoSantander5">
            </aside>
    ...
    <script src="../../js/municipios/puertoSantander.js"></script>
</body>

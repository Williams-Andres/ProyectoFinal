<%-- 
    Document   : villaCaro
    Created on : 20/07/2023, 06:05:19 PM
    Author     : William
--%>
...
<head>
    ...
    <link rel="stylesheet" href="../../css/municipios/villaCaro.css" />
</head>
...
<body>
    ...
    <main>
        <h1>Villa Caro Norte de Santander</h1>
        <div class="contenido">
            <aside class="imagenes">
                <img class="imagen1" src="/src/municipios/villaCaro/" alt="imagenVillaCaro1">
                <img class="imagen2" src="/src/municipios/villaCaro/" alt="imagenVillaCaro2">
                <img class="imagen3" src="/src/municipios/villaCaro/" alt="imagenVillaCaro3">
                <img class="imagen4" src="/src/municipios/villaCaro/" alt="imagenVillaCaro4">
                <img class="imagen5" src="/src/municipios/villaCaro/" alt="imagenVillaCaro5">
            </aside>
    ...
    <script src="../../js/municipios/villaCaro.js"></script>
</body>
